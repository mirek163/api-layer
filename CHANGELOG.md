...
* Feature:  Revoke a Personal Access Token by admin (#2476) ([e4d42a9](https://github.com/zowe/api-layer/commit/e4d42a9)), closes [#2476](https://github.com/zowe/api-layer/issues/2476)
...
* Feature:  Fix SAF IDT scheme and service. This adds the possibility to call a SAF IDT service with a password/passticket (#2224) ([7772401](https://github.com/zowe/api-layer/commit/7772401)), closes [#2224](https://github.com/zowe/api-layer/issues/2224)
* Feature:  Generate a Personal Access Token (#2452) ([0e39aa7](https://github.com/zowe/api-layer/commit/0e39aa7)), closes [#2452](https://github.com/zowe/api-layer/issues/2452)
...
* Feature:  Validate the ServiceId with an endpoint (#2413) ([9f3825f](https://github.com/zowe/api-layer/commit/9f3825f)), closes [#2413](https://github.com/zowe/api-layer/issues/2413)
* Feature:  Support of an expired password in ZAAS client (#2404) ([4eab709](https://github.com/zowe/api-layer/commit/4eab709)), closes [#2404](https://github.com/zowe/api-layer/issues/2404)
