...
public class ServiceAuthenticationServiceImpl implements ServiceAuthenticationService {
    ...
    public ServiceAuthenticationServiceImpl(@Qualifier("local")EurekaClient discoveryClient, EurekaMetadataParser eurekaMetadataParser, AuthenticationSchemeFactory authenticationSchemeFactory, CacheManager cacheManager, CacheUtils cacheUtils) {
