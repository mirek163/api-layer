module.exports = {
    ...
    packageRules: [
        {
            //for v.2.x.x branch find all packages which are minor and patches,
         ...
         {
             //for v.2.x.x make dashboard approval to all major dependencies updates
             "matchBaseBranches": ["v3.x.x-renovate"],
             "matchUpdateTypes": ["major"],
             "dependencyDashboardApproval": true,
         },
         {
             //for v.3.x.x branch ignore grouping from extends preset, find all packages which are patches,
