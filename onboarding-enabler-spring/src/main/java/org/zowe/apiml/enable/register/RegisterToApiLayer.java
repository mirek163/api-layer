...
public class RegisterToApiLayer {
    ...
    @Value("${eureka.client.healthcheck.enabled:false}")
    private boolean eurekaHealthCheckEnabled;
    ...
    private void register(ApiMediationServiceConfig newConfig) {
        ...
        try {
            ...
            if (eurekaHealthCheckEnabled)
                apiMediationClient.getEurekaClient().registerHealthCheck(healthCheckHandler);
